...
Feature: 
   ...
   #  |	"Mhbp Test"				|	"MHBP"							|	"YES"						|			"CONTINUE"				|	"TestID123"	|	"N/A"						|	"222222"		|	"12/12/1980"	|	"CA"			|	"PRIMARY"			|	"NOT SURE"							|	#TC_Fed_5.2 
		...
		Scenario Outline: TC_Fed_06,07 :Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
		 ...
		 Examples: 
      | patientName				|insuranceProvider	|usedHearingAid	| Nothanks_or_Continue|			MemberID	|EnrollmentCode	|	GroupNumber	|			DOB			|Residence|	InsuranceType	|BenifitsInLast36Months	|
      | "Bcbs Test"				|			"BCBS"				|		"YES"				|			"CONTINUE"			|		"R12345678"	|		"104"				|	"65006500"	|	"01/28/1970"|		"N/A"	|	"PRIMARY"			|						"NO"				|#TC_Fed_6.0 
      | "Geha Test"				|			"GEHA"				|		"YES"				|			"CONTINUE"			|		"R87654321"	|		"N/A"				|	"78360001"	|	"01/30/1970"|		"CA"	|	"PRIMARY"			|						"NO"				|#TC_Fed_6.1 
      | "Nalc Test"				|			"NALC"				|		"YES"				|			"CONTINUE"			|		"N12345678"	|		"N/A"				|	"32"				|	"01/30/1947"|		"CA"	|	"PRIMARY"			|						"NO"				|#TC_Fed_6.2  
      | "Aetna Test"			|			"Aetna"				|		"YES"				|			"CONTINUE"			|		"TestID123"	|		"N/A"				|	"111111"		|	"12/12/1980"|   "CA"	|	"PRIMARY"			|						"NO"				|#TC_Fed_7.0 
      |	"Apwu Test"				|"Apwu Health Plan"	|		"NO"				|			"CONTINUE"			|		"TestID123"	|		"N/A"				|	"222222"		|	"12/12/1980"|		"CA"	|	"PRIMARY"			|						"NO"				|#TC_Fed_7.1 
      |	"Mhbp Test"				|			"MHBP"				|		"YES"				|			"CONTINUE"			|		"TestID123"	|		"N/A"				|	"222222"		|	"12/12/1980"|		"CA"	|	"PRIMARY"			|						"NO"				|#TC_Fed_7.2 
		...
		Scenario Outline: TC_Fed_08 : Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
		 ...
		 @TC_Fed_08		
		 Examples: 
      | patientName	|	insuranceProvider	|	usedHearingAid	| Nothanks_or_Continue	|	MemberID		|	EnrollmentCode	|	GroupNumber	|	MedicareNumber	|	DOB						|	Residence	|	InsuranceType	|	BenifitsInLast36Months	|
      | "Bcbs Test"	|	"BCBS"						|	"YES"						|	"CONTINUE"						|	"R12345678"	|	"104"						|	"65006500"	|	"N/A"						|	"01/28/1970"	|	"N/A"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_8.0 
      | "Geha Test"	|	"GEHA"						|	"YES"						|	"CONTINUE"						|	"R87654321"	|	"N/A"						|	"78360001"	| "N/A"						|	"01/30/1970"	|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_8.1 
      | "Nalc Test"	|	"NALC"						|	"YES"						|	"CONTINUE"						|	"N12345678"	|	"N/A"						|	"32"				|	"med-123-02"		|"01/30/1947"		|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_8.2 
		...
		Scenario Outline: TC_Fed_10 : Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
		 ...
		 @TC_Fed_10	
		 Examples: 
      | patientName				|insuranceProvider|usedHearingAid	|changedInsuranceProvider	| Nothanks_or_Continue|			MemberID	|EnrollmentCode	|	GroupNumber	|			DOB			|Residence|	InsuranceType	|BenifitsInLast36Months	|
      | "Bcbs Test"				|			"BCBS"			|			"YES"			|				"GEHA"						|			"CONTINUE"			|		"R87654321"	|		"N/A"				|	"78360001"	|	"01/28/1970"|		"CA"	|	"PRIMARY"			|						"NO"				|#TC_Fed_10.0 
  ...
  @federal_form
		Scenario Outline: TC_Fed_09 : Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
			...
			And Submitted details should be present in Salesforce #(if No on 36month question then order will be placed)
		
		 @TC_Fed_09		
		 Examples: 
      | patientName	|	insuranceProvider	|	usedHearingAid	| Nothanks_or_Continue	|	MemberID		|	EnrollmentCode	|	GroupNumber	|	MedicareNumber	|	DOB						|	Residence	|	InsuranceType	|	BenifitsInLast36Months	|
      | "Bcbs Test"	|	"BCBS"						|	"YES"						|	"CONTINUE"						|	"R12345678"	|	"104"						|	"65006500"	|	"N/A"						|	"01/28/1970"	|	"N/A"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_9.0 
      | "Geha Test"	|	"GEHA"						|	"YES"						|	"CONTINUE"						|	"R87654321"	|	"N/A"						|	"78360001"	| "N/A"						|	"01/30/1970"	|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_9.1 
      | "Nalc Test"	|	"NALC"						|	"YES"						|	"CONTINUE"						|	"N12345678"	|	"N/A"						|	"32"				|	"med-123-02"		|"01/30/1947"		|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_9.2 
   ...
   @federal_form1
    Scenario Outline: TC_Fed_10 : Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
      ...
      When I submit the federal form with insurance provider as <insuranceProvider> and for ever used hearing aids option as <usedHearingAid>
      And I select <Nothanks_or_Continue> for maximum benefits for health insurance
      And I enter Member ID as <MemberID>, Enrollment code as <EnrollmentCode>, Group Number as <GroupNumber>, Date of Birth as <DOB> State of resident as <Residence> with zipcode <zipCode> and Insurance type as <InsuranceType>
      And I select <BenifitsInLast36Months> for using Hearing Aid insurance benefits in last 36 months
      And I change the insurance provider as <changedInsuranceProvider>
      And I select <Nothanks_or_Continue> for maximum benefits for health insurance
      And I enter Member ID as <MemberID>, Enrollment code as <EnrollmentCode>, Group Number as <GroupNumber>, Date of Birth as <DOB> State of resident as <Residence> with zipcode <zipCode> and Insurance type as <InsuranceType>
     ...
     Examples: 
      | patientName	|	insuranceProvider |	usedHearingAid	| Nothanks_or_Continue	|	MemberID  	|	EnrollmentCode  |	GroupNumber |	DOB      			|	Residence	|	zipCode	|	InsuranceType	|	BenifitsInLast36Months |	changedInsuranceProvider	|
      | "Bcbs Test" |  "BCBS"       		| "YES"     			| "CONTINUE"      			| "R12345678" | "104"        		| "65006500"  | "01/28/1970"	| "N/A"  		|	"N/A"  	|	"PRIMARY"    	| "NO"       						 |  "GEHA"         						|	#TC_Fed_10.0
   ...
   @federal_form
		Scenario Outline: TC_Fed_11 : Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
		 ...
		 Examples: 
      | patientName	|	insuranceProvider	|	usedHearingAid	| Nothanks_or_Continue	|	MemberID		|	EnrollmentCode	|	GroupNumber	|	MedicareNumber	|	DOB						|	Residence	|	InsuranceType	|	BenifitsInLast36Months	|
      | "Nalc Test"	|	"BCBS"						|	"YES"						|	"CONTINUE"						|	"R12345678"	|	"104"						|	"65006500"	|	"N/A"						|	"01/28/1970"	|	"N/A"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_11.0 
      | "Bcbs Test"	|	"GEHA"						|	"YES"						|	"CONTINUE"						|	"R87654321"	|	"N/A"						|	"78360001"	| "N/A"						|	"01/30/1970"	|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_11.1 
      | "Geha Test"	|	"NALC"						|	"YES"						|	"CONTINUE"						|	"N12345678"	|	"N/A"						|	"32"				|	"med-123-02"		|"01/30/1947"		|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_11.2 
    ...
    @federal_form
		Scenario Outline: TC_Fed_12 : Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
		 ...
		 Examples: 
      | patientName	|	insuranceProvider	|	usedHearingAid	| Nothanks_or_Continue	|	MemberID		|	EnrollmentCode	|	GroupNumber	|	MedicareNumber	|	DOB						|	Residence	|	InsuranceType	|	BenifitsInLast36Months	|
      | "Bcbs Test"	|	"BCBS"						|	"YES"						|	"CONTINUE"						|	"R12345678"	|	"104"						|	"65006500"	|	"N/A"						|	"01/28/1970"	|	"N/A"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_12.0 
      | "Geha Test"	|	"GEHA"						|	"YES"						|	"CONTINUE"						|	"R87654321"	|	"N/A"						|	"78360001"	| "N/A"						|	"01/30/1970"	|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_12.1 
      | "Nalc Test"	|	"NALC"						|	"YES"						|	"CONTINUE"						|	"N12345678"	|	"N/A"						|	"32"				|	"med-123-02"		|"01/30/1947"		|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_12.2 
    ...
    @federal_form
		Scenario Outline: TC_Fed_13 : Submit a federal form to verify get maximum benifits on health insurance and verify the details on Salesforce
		 ...
		 Examples: 
      | patientName	|	insuranceProvider	|	usedHearingAid	| Nothanks_or_Continue	|	MemberID		|	EnrollmentCode	|	GroupNumber	|	MedicareNumber	|	DOB						|	Residence	|	InsuranceType	|	BenifitsInLast36Months	|
      | "Bcbs Test"	|	"BCBS"						|	"YES"						|	"CONTINUE"						|	"R12345678"	|	"104"						|	"65006500"	|	"N/A"						|	"01/28/1970"	|	"N/A"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_13.0 
      | "Geha Test"	|	"GEHA"						|	"YES"						|	"CONTINUE"						|	"R87654321"	|	"N/A"						|	"78360001"	| "N/A"						|	"01/30/1970"	|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_13.1 
      | "Nalc Test"	|	"NALC"						|	"YES"						|	"CONTINUE"						|	"N12345678"	|	"N/A"						|	"32"				|	"med-123-02"		|	"01/30/1947"	|	"CA"			|	"PRIMARY"			|	"NO"										|	#TC_Fed_13.2 
