...
#			And I add a accessory <acc> in cart
    ...
    Examples: 
      | prod	| acc 					| price		|accPrice| couponCode			|	state					|	zipCode		|	deliverBy 					| payment	| 
	    | "Neo"	|"Flexi Domes"	| "$2350" |	"$25"  | "HIFILAUNCH" 	|	"NEWJERSEY"		|	"07097"		|	"3-4 business days"	| "Bread"	|	#TC-NJSHOP-05 (Normal Order)
...
#@smokeTest @regressionTest @multipleProductOrderUsingBread @TC-NJSHOP-39 @mentionMe
    ...
    Examples: 
      | prod	| acc 					| price		|accPrice| mentionMe				|	state					|	zipCode		|	deliverBy 					| payment	| 
	    | "Neo"	|"Flexi Domes"	| "$2350" |	"$25"  | "FriendReferal" 	|	"NEWJERSEY"		|	"07097"		|	"3-4 business days"	| "Bread"	|	#TC-NJSHOP-39 (Mention Me)
...
#@smokeTest1 @regressionTest @multipleProductOrder @TC-NJSHOP-47
    ...
    Examples: 
     ...
     |	"Max"	|"Flexi Fibers"	| "$1850" |	"$25"  | "Hear250" 			|"NEWJERSEY"		|	"07097"		|	"3-4 business days"	|  "FLORIDA"		|	"32003"    			|	"Bread"	|	#TC-NJSHOP-47 (Different Shipping Address)
